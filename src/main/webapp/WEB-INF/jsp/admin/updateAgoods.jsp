	...
	<form:form action="adminGoods/addGoods?updateAct=update" method="post" modelAttribute="goods" enctype="multipart/form-data">
		<table border=1 style="border-collapse: collapse">
			...
			<tr>
				<td>图片</td>
				<td>
<%--					<img alt="" width="50" height="50" id="img" src="">--%>
					<input type="file" name="logoImage" onchange="displayimg(this)" />
					<br>
					<!-- 从数据库取出的文件名 -->
<%--					<c:if test="${goods.gpicture != ''}">--%>
						<img alt="" width="50" height="50" id="img" src="logos/${goods.gpicture}"/>
<%--					</c:if>--%>
				</td>
			</tr>
			<tr>
